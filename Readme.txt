...
And enter the 'chmod +x /Luna-s-useless-but-fun-tools/Permission.sh' command
Running chmod +x /Luna-s-useless-but-fun-tools/Permission.sh will allow you to run all scripts
